  ...
  return <motion.div initial={{
    ...
    y: 0
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        scale: 0.95
      }} onClick={onSync} disabled={syncing} className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-primary/10 text-primary text-sm font-medium hover:bg-primary/20 transition-colors disabled:opacity-50">
