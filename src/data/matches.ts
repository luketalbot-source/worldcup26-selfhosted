...
export const groupStageMatches: Match[] = [
  // ============ TEST MATCHES ============
  createMatch('TEST1', 'eng', 'bra', 'January 27, 2026', '16:00', 'Test Stadium', 'Test City', 'A'),
  createMatch('TEST2', 'fra', 'arg', 'January 27, 2026', '21:00', 'Test Stadium', 'Test City', 'A', 'live', 2, 1),
